...
The best linear model is the one that has the smallest residuals. We don't need to worry about the details of how we find this line - however, the mathematics behind this assume that the residuals have a *normal* distribution (more or less).
